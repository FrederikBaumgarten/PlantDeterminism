...
\begin{document}
	...
	\title{(In)determinacy in woody plants: limits and opportunities for timing growth in a changing climate %(my favourite)
...
\textbf{Authors contribution:}
	...
	The data supporting the phylogeny are archived in the following public repository. Link: \href{https://doi.org/10.5281/zenodo.18637216}{https://doi.org/10.5281/zenodo.18637216}.\\
...
\section*{Abstract} %200 words for perspective 
	...
	When and how much organisms grow given environmental constraints are fundamental questions in biology, and especially pressing given the need to predict biomass production and carbon sequestration with climate change. While environmental factors such as temperature and water availability directly regulate plant growth, the timing and rate of growth are also governed by a plant’s phenological sequence—its genetically programmed developmental stages. This sequence is critical for predicting climate responses but often underappreciated. %emw5May2026: This is a fair bit of text devoted to background; if you wanted to address R1's concerns, this would be a place to cut to buy more space (and the next sentence might be a place to add that the concept varies across fields and, within woody plants, tissue types)
...
\section*{Introduction} 
		Investing the right amount of resources in growth at the right time is of critical importance to the survival and fitness of any living organism. The topic of growth strategies and habits has a long history in science, spanning the fields of genetics, genomics, physiology and ecology across the animal and plant kingdoms \citep{stearnsEvolutionLifeHistories1998a}. At its core lies the concept of determinacy—the classification of organisms as either reaching a fixed size at maturity or continuing to grow throughout their lives. Like mollusks, fish and reptiles, plants add biomass to their primary bodies as long as they live and are therefore considered ‘indeterminate growers’  \citep{ejsmondHowTimeGrowth2010}. \\ %emw5May2026: Why not just change this citation to address R1's concerns a little? 
		
		Various terms have emerged to describe this phenomenon across spatial and temporal scales, e.g. from a single cell to the whole organism, and from a single season to an entire lifetime \citep{mcdanielInductionDeterminationDevelopmental1992a, karkachTrajectoriesModelsIndividual2006}. In plants, organs can develop from preformed embryonic tissue (e.g. primordia in overwintering buds), form \textit{de novo}, or both, depending on species and life form. While these underlying developmental and meristematic constraints apply broadly across the plant kingdom, they play a particularly central role in the life cycle of woody perennials, especially trees growing in extra-tropical regions, which must balance growth, survival, and reproduction over long lifespans in highly seasonal environments. As we use it here, (in)determinacy in woody perennials refers to the ability to:\\

		a) preform organs in one year as a future investment, which is deployed rapidly in the following (or later) spring with no further primary shoot growth during that season (determinate strategy);\\ %emw5May2026: Not critical to change but some plants take more than a year so I added '(or later)'
		b) maintain continuous or episodic meristem activity by forming new shoot tissue during the current growing season (indeterminate strategy).\\ %emw5May2026: 'to maintain activity' and 'to maintain a activity' are different to me, with the former more common

		
%emw5May2026: Doesn't the below do what R1 wanted? Consider editing this just a little and saying you did address this concern; see also my comments in the letter. 		
In this Perspective, we revisit classical concepts of determinacy as they relate to shoot growth in woody perennials, place them in the context of climate change, and explore to what extent related developmental principles may also inform growth processes in other meristematic tissues. Although we focus on woody perennials, the concept of (in)determinacy is broadly relevant across vascular plants, including herbaceous species; trees provide a particularly informative model system because the ecological and climatic consequences of growth timing are especially pronounced in long-lived woody plants. To provide context, we first outline the fundamental limitations to plant growth in extra-tropical regions by linking external environmental drivers with internal growth control mechanisms. In this context, our aim is to provide a conceptual and methodological basis for analysing (in)determinacy as a trait relevant to plant responses to climatic variability and change, to clarify how the concept can be defined and measured, and to identify key research gaps and directions for future comparative and trait-based analyses.\\		% In some tropical ecosystems a continued production of tissue by trees can be both possible and advantageous; in all other regions, however, strategies that rely on growth from stored reserves and pre-built tissue are common.
	%\subsection*{Seasonality of temperature, soil moisture and light} %emw5May2026: I read the paper first and then read the letter and this felt odd and abrupt to me ... if you want to remove this subheader I think then you need to massively shorten the below text and move it BEFORE the previous paragraph. Instead,  I would bring this subheader back and just make it a full header. 
		
		The further one travels from the equator towards the poles, the more strongly plants are confined to a shrinking temporal window of opportunity for growth set primarily by low temperatures. Below c. 5 °C, metabolic activity slows to an extent where growth and development largely cease \citep{schenkerPhysiologicalMinimumTemperatures2014, rossiCriticalTemperaturesXylogenesis2008, kornerWinterCropGrowth2008}. More importantly, sub-freezing temperatures can cause severe damage to plant tissue if they occur at vulnerable developmental stages, e.g. during or after leaf unfolding, prior to fruit maturation, or before cold acclimation in fall \citep{sakaiFreezingInjuriesPlants1987c, baumgartenNoRiskNo2023a}. 
		While annual plant species accommodate their entire life cycle within this window, perennial (woody) species of extra-tropical regions are forced to partition their growth phase seasonally, with periods of activity alternating with periods of dormancy \citep{delpierreTemperateBorealForest2016}. This is referred to as intermittent or rhythmic (as opposed to continuous) growth. \\
 ...
 Notably, comparable (or even stronger) seasonal constraints occur in seasonally dry forests as is typical in Mediterranean climates, where temperatures may remain suitable for growth year-round but multi-month dry seasons impose pronounced water limitation. Across species, leaf flush and renewed growth commonly track the onset of rains and access to plant-available water (including deep soil moisture), making soil water availability a primary driver of seasonal activity in these systems \citep{borchertSoilStemWater1994, ramosMultiscalePhenologySeasonally2023, alvaradoCambialActivityFive2025}.\\
 
	
		
		Light also influences plant growth through two key processes. First, light intensity provides the primary energy source that drives photosynthesis and, consequently, source activity. Second, light carries a wealth of information through its quality and the length of daily light and dark periods (photoperiod), which mediate many physiological processes, including bud set and dormancy transitions \citep{wangPlantsDistinguishDifferent2024b}. Both factors may contribute to the common observation that tree growth often peaks near the summer solstice in extra-tropical regions \citep{rossiConifersColdEnvironments2006, etzoldNumberGrowthDays2021, luoSummerSolsticeMarks2018} or that a window of temperature sensitivity `opens’ around the summer solstice to synchronize reproductive efforts over very large spatial scales \citep{journeSummerSolsticeOrchestrates2024}. %emw5May2026: I do not agree with this paper in part because the stats are really poor, I would cut this clause or you could also cite a counter paper -- Van der Meersch and I have one in PNAS from last year. 
...
\subsection*{The concept of (in)determinate growth}
	...
	%emw5May2026: Below, I added 'woody'
	In their first year, all woody seedlings exhibit indeterminate growth. They begin growth from an embryonic shoot meristem and typically prioritize rapid leaf and canopy establishment, reflecting a juvenile, largely opportunistic phase of development\citep{borchertConceptJuvenilityWoody1976}. In subsequent years, many temperate and boreal tree species preform their new shoot increments during the previous growing season, overwintering them as primordial shoots with leaves and internodes in hardened buds to be `ready-to-go' when spring arrives. Once the leaves flush and the preformed internodes elongate, species differ in how long the shoot apical meristem remains competent to continue organ production (Figure~\ref{fig:fig_2xxx}). Some species exhibit strongly determinate shoot extension, in which the terminal meristem is intrinsically downregulated soon after the spring flush and remains inactive for the rest of the season, consistent with a prolonged internal suppression that is hormonally mediated (paradormancy; \citealp{langEndoParaEcodormancy1987}; Figure~\ref{fig:phylo}; e.g. \textit{Fraxinus} spp., \textit{Acer} spp. and \textit{Prunus} spp.). 	
	At the other extreme, highly indeterminate species maintain an active shoot apical meristem and can continue producing new leaves and internodes on top of the preformed shoot as long as conditions remain favorable, sometimes stretching their indeterminate growth well into autumn until low temperature eventually forces them to stop (e.g. \textit{Sequoia} spp., \textit{Cupressus} spp. and \textit{Alnus} spp.). %emw5May2026:  Can we add a citation for this? I was not aware of this ... if we don't have a citation we should soften the language to sound less sure. 
	Between these extremes, many species occupy an intermediate position: they continue to produce neoformed leaves and internodes after the preformed increment, but growth cessation is often coordinated by seasonal cues—frequently photoperiod acting through hormonal regulation (e.g. \textit{Pinus} spp., \textit{Betula} spp. and \textit{Populus} spp.; \citealp{mauryaPhotoperiodTemperaturemediatedControl2017, triozziPhotoperiodicRegulationShoot2018, bohleniusCOFTRegulatory2006a}). Indeterminate growth can occur either through continuous activity of the shoot apical meristem forming new leaves and internodes without buds (free growth), or through the formation and subsequent flushing of buds mid-season without a period of dormancy (second flushing or lammas growth; Figure~\ref{fig:fig_2xxx}).\\
	
	
	

	
Although this concept is often presented dichotomously \citep{kozlowskiGrowthControlWoody1997, lechowiczWhyTemperateDeciduous1984a}, but see \citealp{kikuzawaLeafSurvivalWoody1983, damascosBudCompositionBranching2005}), with species classified as either determinate or indeterminate growers, most species likely exist along a gradient with numerous intermediate forms. For instance, many temperate oaks (\textit{Quercus spp.}) are considered determinate growers, but can exhibit multiple flushes. Similarly, Douglas-fir (\textit{Pseudotsuga menziesii}) gradually adopts a more determinate growth habit with maturity \citep{borchertConceptJuvenilityWoody1976, heuretOntogeneticTrendsMorphological2006}.

 Importantly, the degree of determinacy can be quantified at the species level, at least for the shoot apical meristem as the ratio of leaves produced during the relevant growth period to the number of leaf primordia preformed in the bud, with values above 1 indicating increasing neoformation (Box~\ref{box:metrics}). Figure~\ref{fig:phylo} provides a literature-based classification of determinacy for some common species, many of which fall into an intermediate position.\\
...
In most temperate and boreal ecosystems, determinate and indeterminate growth strategies co-occur, indicating that neither strategy is universally superior. Instead, they reflect contrasting solutions to a fundamental trade-off between growth certainty and growth flexibility under seasonal and variable environments.\\ %emw5May2026: nice stuff in this paragraph

Indeterminate species are characterized by continued or episodic activity of the shoot apical meristem during the growing season. This does not necessarily imply faster intrinsic growth rates, but rather a greater capacity to extend growth %emw5May2026: 'in time' reads off to me ... you could write 'during periods' or 'during times' or just cut it (which is what I did)
 when conditions remain favorable. Such temporal flexibility allows individuals to exploit transient resource availability and recover from partial damage, traits that are advantageous in disturbed or early-successional environments. Accordingly, indeterminate growth is frequently associated with early successional species \citep{marksRelationExtensionGrowth1975}. However, maintaining active meristems later into the season also increases exposure to environmental stressors such as summer drought and early autumn frost, thereby raising the risk of tissue loss or incomplete maturation (Figure~\ref{fig:phylo}). As a result, indeterminate growth strategies often involve higher interannual variability in performance and, in some cases, shorter tissue or organismal lifespans \citep{milletRelationshipArchitectureSuccessional1999, brienenForestCarbonSink2020b}.\\

In contrast, determinate species preform a substantial portion of their shoot growth in advance and deploy this tissue during a restricted period of the growing season. This strategy limits short-term plasticity, because the year's shoot-growth potential is set during bud formation in the preceding year and is largely realized by expanding preformed organs \citep{gordonPreformationVegetativeBuds2006}. At the same time, it reduces exposure of sensitive tissues to late-season stress and synchronizes growth with the most predictable and favorable part of the season. As a consequence, determinate growth strategies are often associated with stronger local adaptation and reduced sensitivity to short-term climatic fluctuations \citep{leitesForestTreeSpecies2023}.\\
...
%	Although photoperiod appears to be a key regulator of seasonal growth and development in many species, most of our knowledge comes from model organisms, with poplar being the main woody perennial studied in detail. Thus, genetic control mechanisms of (in)determinacy that set the potential of tree growth across species are yet to be discovered. \\ 
	...
	\subsection*{(In)determinacy beyond primary shoot growth} %emw5May2026: Is this section new? It's okay but it could be tighter so I would cut words/sentences where you can. 
	Although (in)determinacy is most clearly defined \textit{sensu stricto} at the shoot apical meristem, its relevance may extend beyond primary shoot growth because shoot extension and cambial growth are structurally and functionally coordinated within the plant. Primary growth governs crown expansion and annual leaf deployment, thereby influencing total leaf area and canopy photosynthetic capacity \citep{girardPolycyclismFundamentalTree2011, soolanayakanahallyComparativePhysiologyAllopatric2015}. Primary shoot growth also establishes the structural framework within which later radial growth can occur by determining the extent and geometry of axes along which cambial activity can be expressed. Empirical studies showing close within-season associations between shoot extension and stem or radial growth therefore point less to simple control by one process over the other than to coordinated development between apical and cambial meristems \citep{cunyLifeStrategiesIntraannual2012, zhangForestsGrowthMonitoring2019}.\\
	
	At the same time, we do not suggest that cambial growth is simply controlled by newly formed leaves or by current assimilate supply. Primary and secondary growth have partially distinct controls and constraints, and cause-and-effect relationships between them are not straightforward \citep{hartmannUnderstandingRolesNonstructural2016a, trugmanSourceVsSink2025}. Rather, from a whole-plant perspective, sustained production of additional leaves, xylem, and phloem is likely to be coordinated because each entails construction and maintenance costs that are only advantageous if matched by corresponding hydraulic and carbon-transport demands. In this sense, variation in shoot (in)determinacy may provide insight into how woody plants coordinate continued axis extension with continued secondary tissue production over the course of a growing season. In highly indeterminate species, continued primary growth later in the season may therefore be viewed not only as prolonged leaf or shoot production, but as part of a broader developmental syndrome in which the extension of axes and the continuation of cambial activity remain jointly permissive for longer.\\
	
	Although vascular development is not preformed in the same mechanistic sense as shoot organs enclosed in buds, seasonal carry-over in vascular tissues---particularly where conductive phloem persists through winter---may represent a functional analogue of preformation, in that part of the transport system available early in the next season was established previously \citep{savageItsAllTiming2020, savageCoordinationSpringVascular2021}. This suggests that concepts related to developmental carry-over may extend beyond primary shoot growth, while still remaining distinct from preformation \textit{sensu stricto} at the shoot apical meristem. The timing and duration of cambial cell division constrain the rate and seasonal extent of secondary growth by limiting the number of cells entering differentiation, while subsequent cell maturation imposes additional carbon and resource demands that can further restrict wood formation \citep{lupiXylemPhenologyWood2010}. At the same time, cambial cell production can cease even when environmental conditions remain favorable and the canopy is still photosynthetically active, pointing to internal regulation of secondary growth \citep{buttoComparingCellDynamics2020, arendStemGrowthPhenology2024}.\\
	...
	Together, these observations suggest that although (in)determinacy is most rigorously defined at the shoot apical meristem, variation in primary shoot growth may still have important downstream consequences for whole-plant performance. In this sense, shoot-level determinacy may provide a useful lens for studying coordination among plant growth processes, even where other organs operate through different developmental mechanisms.\\
